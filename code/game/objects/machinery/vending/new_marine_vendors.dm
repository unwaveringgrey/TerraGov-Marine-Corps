...
/obj/machinery/marine_selector/clothes
	...
	listed_products = list(
		...
		/obj/item/clothing/suit/attachment/marine = list(CAT_AMR, "Regular Armor", 0, "orange"),
		/obj/item/clothing/suit/attachment/marine/M3HB = list(CAT_AMR, "Heavy Armor", 0, "black"),
		/obj/item/clothing/suit/attachment/marine/M3LB = list(CAT_AMR, "Light Armor", 0, "black"),
		/obj/item/clothing/suit/attachment/marine/M3IS = list(CAT_AMR, "Integrated Storage Armor", 0, "black"),
		/obj/item/clothing/suit/attachment/marine/harness = list(CAT_AMR, "Harness", 0, "black"),
...
/obj/machinery/marine_selector/clothes/synth
	...
	listed_products = list(
		...
		/obj/item/clothing/suit/attachment/marine/MP = list(CAT_AMR, "N2 pattern MA armor", 0, "black"),
		/obj/item/clothing/suit/attachment/marine/MP/RO = list(CAT_AMR, "M3 pattern officer armor", 0, "black"),
